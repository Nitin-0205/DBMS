...
bgImage = PhotoImage(file="MainBg.png")
...
roomNumber = PhotoImage(file="roomNumberIco.png")
...
def allOrders():
    ...
    usernameimg = PhotoImage(file='orderTitle.png')
...
Home_Buttonimg = PhotoImage(file='HomeBtn.png')
...
logBg = PhotoImage(file='logInBg.png')
...
HomeFrameBGimg = PhotoImage(file='logBg.png')
...
Hotel_Titleimg = PhotoImage(file='sasuke.png')
...
RoomBtnimg = PhotoImage(file='Room.png')
...
FoodBtnimg = PhotoImage(file='Food.png')
...
CheckOutBtnimg = PhotoImage(file='checkout.png')
...
kak = PhotoImage(file='kakashi.png')
...
signCheck = PhotoImage(file='Nsign.png')
...
guestBG = PhotoImage(file='guestBG.png')
...
chekInBtnIco = PhotoImage(file="chekInBtnIco.png")
...
paybut = PhotoImage(file="pay.png")
paybut = paybut.subsample(2,2)

Paybg=PhotoImage(file="payBack.png")
